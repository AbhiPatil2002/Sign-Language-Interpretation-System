...
class Application:
    def _init_(self):
        ...
        self.json_file = open(r"E:\Major project\Sign Language\Sign-Language-To-Text-Conversion-main\Models\model_new2.json")
        self.model_json = self.json_file.read()
        self.json_file.close()
        self.loaded_model = model_from_json(self.model_json)
        self.loaded_model.load_weights("E:\Major project\Sign Language\Sign-Language-To-Text-Conversion-main\Models\model_new.h5")

        # Load the pre-trained model for D, R, U predictions
        self.json_file_dru = open(r"E:\Major project\Sign Language\Sign-Language-To-Text-Conversion-main\Models\model-bw_dru.json")
        self.model_json_dru = self.json_file_dru.read()
        self.json_file_dru.close()
        self.loaded_model_dru = model_from_json(self.model_json_dru)
        self.loaded_model_dru.load_weights("E:\Major project\Sign Language\Sign-Language-To-Text-Conversion-main\Models\model-bw_dru.h5")

        # Load the pre-trained model for D, I, K, T predictions
        self.json_file_tkdi = open(r"E:\Major project\Sign Language\Sign-Language-To-Text-Conversion-main\Models\model-bw_tkdi.json")
        self.model_json_tkdi = self.json_file_tkdi.read()
        self.json_file_tkdi.close()
        self.loaded_model_tkdi = model_from_json(self.model_json_tkdi)
        self.loaded_model_tkdi.load_weights("E:\Major project\Sign Language\Sign-Language-To-Text-Conversion-main\Models\model-bw_tkdi.h5")

        # Load the pre-trained model for M, N, S predictions
        self.json_file_smn = open(r"E:\Major project\Sign Language\Sign-Language-To-Text-Conversion-main\Models\model-bw_smn.json")
        self.model_json_smn = self.json_file_smn.read()
        self.json_file_smn.close()
        self.loaded_model_smn = model_from_json(self.model_json_smn)
        self.loaded_model_smn.load_weights("E:\Major project\Sign Language\Sign-Language-To-Text-Conversion-main\Models\model-bw_smn.h5")
        ...
        self.bt_speak = tk.Button(self.root, text="Speak", command=self.speak_current_word, font=("Courier", 20))
        self.bt_speak.place(x=650, y=550)
